...
export const Navbar = () => {
    ...
    return (
        <nav
            className="flex-no-wrap relative flex  items-center justify-between bg-[#FBFBFB] p-2 ">
            <div className="flex  w-screen items-center justify-between px-3">
                <button
                ...
                <div className="relative flex items-center">
                    ...
                    {/* DRAWER button */}
                    <button
                        className="flex items-center transition duration-150 ease-in-out motion-reduce:transition-none"
