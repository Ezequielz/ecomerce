...
export const Slider = () => {
    ...
    return (
        <div className='p-0 bg-[#fd611a] relative shadow-lg'>
            <picture className="">
                <img src="http://localhost:3000/images/slider.png" className="m-auto block text-clip h-[2.84rem] object-cover" alt="slider -pedidos unicamente via web-" />
            </picture>
                <div className="absolute flex justify-end top-[11px] right-1.5 p-0 cursor-pointer" onClick={() => setShow(false)}>
