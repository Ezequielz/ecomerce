...
export const Chip = ({ text }: { text: string }) => {
    ...
    return (
        <span className="inline-flex items-center px-2 py-1 mr-2 text-sm font-medium text-white bg-[#fd611a] rounded-lg">
            {text}
            <button type="button" className="inline-flex items-center p-0 ml-2 text-sm  rounded-sm " >
